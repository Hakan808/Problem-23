// Bileşen form içeriyor ve butona tıklandığında input alanına otomatik olarak odaklanmasını sağlar.
...
export default function Form() {
  ...
  return (
    <div className='p-8 mx-auto'>
      <div className='px-5 max-w-sm py-5 shadow sm:rounded-lg sm:p-6'>
        ...
        <form className='mt-5 sm:flex sm:items-center'>
          <div className='w-full sm:max-w-xs'>
            ...
            ref={inputRef}
              ...
              name='email'
              id='email'
              className="px-2 block w-full rounded-md border border-gray-300 py-1.5 text-gray-900
                placeholder:text-gray-400 sm:text-sm sm:leading-6 outline-none
                transition-all duration-300 ease-in-out
                focus:ring-2 focus:ring-indigo-500
                focus:border-indigo-500
                focus:shadow-lg focus:shadow-indigo-400/50
                focus:w-72"
          ...
          <button
            type='button'
            className='  mt-3 inline-flex w-full items-center justify-center rounded-md bg-indigo-600
              px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500
              focus-visible:outline-2 focus-visible:outline-offset-2
              focus-visible:outline-indigo-600 sm:ml-3 sm:mt-0 sm:w-auto
              transition ' onClick={handleFocus}
          >
            Focus
          </button>
        </form>
